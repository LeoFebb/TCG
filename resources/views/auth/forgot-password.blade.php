...
<div class="w-full max-w-md px-6">
    ...
    <div class="rounded-2xl p-8 border border-purple-900/50"
        ...
        <div class="text-center mb-6">
            ...
            <h1 class="text-2xl font-black text-white mb-2">Password dimenticata?</h1>
        ...
        @if(session('status'))
            <div class="bg-green-900/50 border border-green-700 text-green-300 px-4 py-3 text-sm rounded-xl mb-6 text-center">
                ✅ {{ session('status') }}
            </div>
        @endif
        ...
        <form method="POST" action="{{ route('password.email') }}" class="space-y-5">
            ...
            {{-- Email --}}
            <div>
                <label class="block text-gray-400 text-sm mb-2">Indirizzo email</label>
