...
@section('title', 'Termini di Servizio — TCG Vault')
    ...
    <div class="max-w-3xl mx-auto px-6 py-16">
        ...
        <div class="space-y-8 text-gray-400 leading-relaxed">
            ...
            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                ...
                <p>Utilizzando TCG Vault accetti i presenti termini di servizio. Se non accetti questi termini non puoi
                    utilizzare la piattaforma.</p>
            </div>

            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                <h2 class="text-xl font-black text-white mb-3">2. Il servizio</h2>
                <p>TCG Vault è un marketplace per la compravendita e lo scambio di carte da gioco collezionabili. Ogni
            ...
            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                ...
                <p>I pagamenti vengono trattenuti dalla piattaforma in modalità escrow e rilasciati al venditore solo dopo
                    la validazione della carta. TCG Vault non è responsabile per eventuali controversie tra utenti.</p>
            </div>

            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                <h2 class="text-xl font-black text-white mb-3">4. Commissioni</h2>
                <p>TCG Vault applica una commissione dell'8% su ogni vendita completata. Le spese di spedizione (€5.90 per
            ...
            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                ...
                <p>Gli utenti sono responsabili delle carte che pubblicano. È vietato pubblicare carte contraffatte, rubate
                    o non di propria proprietà. TCG Vault si riserva il diritto di rimuovere qualsiasi inserzione.</p>
            </div>

            <div class="rounded-xl border border-purple-900/50 p-6" style="background: rgba(45,17,84,0.2);">
                <h2 class="text-xl font-black text-white mb-3">6. Limitazione di responsabilità</h2>
                <p>TCG Vault non è responsabile per danni derivanti dall'uso della piattaforma, inclusi danni diretti,
